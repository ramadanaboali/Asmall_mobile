...
class ProductServices {
  ...
  Future<List<ProductDetail>> getlastAdd(String lang, var token) async {
    ...
    try {
      ...
      if (response.statusCode == 200 && response.body != null) {
        List slideritems =
            json.decode(utf8.decode(response.bodyBytes))["products"];
  ...
  Future<List<OrdersDetail>> getAllOrders(
      String lang, var id, var status) async {
    var url =
        "${baseURL}api/order/get-all-orders-by-userId-and-status?userId=$id&status=$status";
    print(url);
    var header = {
      "lang": lang
      // "Authorization":"Bearer $token"
    ...
    try {
      ...
      if (response.statusCode == 200 && response.body != null) {
        List slideritems =
            json.decode(utf8.decode(response.bodyBytes))["orders"];
  ...
  Future<Map<String, dynamic>> getProductDetails(
      String lang, var product_id) async {
  ...
  Future<List<ProductColorModel>> getProductColor(
      String lang, var product_id) async {
    var url = "${baseURL}api/products/get-product-details?poductId=$product_id";
    print(url);
    var header = {
    ...
    try {
      final response = await http.get(Uri.parse(url), headers: header);
      if (response.statusCode == 200 && response.body != null) {
        List slideritems = json
            .decode(utf8.decode(response.bodyBytes))["product"]["colorDtos"];
  ...
  Future<List<SidesDetail>> getProductSides(String lang, var product_id) async {
    ...
    try {
      ...
      if (response.statusCode == 200 && response.body != null) {
        List slideritems = json
            .decode(utf8.decode(response.bodyBytes))["product"]["sidesDtos"];
  ...
  Future<List<ProductSizeModel>> getProductSize(
      String lang, var product_id) async {
    var url = "${baseURL}api/products/get-product-details?poductId=$product_id";
    print(url);
    var header = {
    ...
    try {
      ...
      if (response.statusCode == 200 && response.body != null) {
        List slideritems =
            json.decode(utf8.decode(response.bodyBytes))["product"]
                ["productSizeDtos"];
  ...
  Future<Map<String, dynamic>> addOrders(String lang, var user_id, double total,
      String address_id, List orderItem) async {
  ...
  Future<List<ProductRateDetail>> getProductRateWithImage(
      String lang, var id) async {
  ...
  Future<List<ProductDetail>> getProductFromSubCategory(
      String lang, var id) async {
  ...
  Future<List<SearchItem>> Search(String lang, var key) async {
    ...
    try {
      ...
      if (response.statusCode == 200 && response.body != null) {
        List slideritems =
            json.decode(utf8.decode(response.bodyBytes))["searchResult"];
  ...
  Future<List<QuestionDetail>> GetQuestion(String lang, var id) async {
    ...
    try {
      ...
      if (response.statusCode == 200 && response.body != null) {
        List slideritems =
            json.decode(utf8.decode(response.bodyBytes))["questionAnswers"];
  ...
  Future<List<ProductSpecifiction>> GesProductSpefication(
      String lang, var id) async {
  ...
  Future<List<BanarDetail>> getBanar(String lang) async {
    ...
    try {
      ...
      if (response.statusCode == 200 && response.body != null) {
        List slideritems =
            json.decode(utf8.decode(response.bodyBytes))["advertisements"];
  ...
  Future<Map<String, dynamic>> addQuestion(
      String lang, String questionText, String productId, String userId) async {
  ...
  Future<Map<String, dynamic>> addAnswer(
      String lang, String AnswerText, String QuestionId, String UserId) async {
  ...
  Future<Map<String, dynamic>> addWatch(
      String lang, String Product_id, String UserId) async {
    var url = "${baseURL}api/productWatch/add-productWatch";
    print(url);
    var header = {"Content-Type": "application/json", "lang": lang};
    var body = {"ProductId": Product_id, "UserId": UserId};
    print(body);
    try {
      print("kkkk22");
      final response = await http.post(Uri.parse(url),
  ...
  Future<Map<String, dynamic>> getSetting(String lang) async {
    ...
    try {
      ...
      if (responce.body.isNotEmpty) {
        print("setting is " + responce.body);
  ...
  Future<List<ProductDetail>> getVendorProduct(String lang, var id) async {
    ...
    try {
      ...
      if (response.statusCode == 200 && response.body != null) {
        List slideritems =
            json.decode(utf8.decode(response.bodyBytes))["data"]["allProducts"];
        return slideritems.map((e) => ProductDetail.fromJson(e)).toList();
      }
    } catch (e) {
      print('$e,,,,error search doctors');
  ...
  Future<List<ProductDetail>> getVendorLastAdded(String lang, var id) async {
    ...
    try {
      ...
      if (response.statusCode == 200 && response.body != null) {
        List slideritems =
            json.decode(utf8.decode(response.bodyBytes))["data"]["lastAdded"];
        return slideritems.map((e) => ProductDetail.fromJson(e)).toList();
      }
    } catch (e) {
      print('$e,,,,error search doctors');
  ...
  Future<List<ProductDetail>> getProductVendorCategory(
      String lang, var vendor_id, var sub_id) async {
    String url = baseURL +
        "api/products/get-all-products-by-subCategory-and-userId?subId=$sub_id&userId=$vendor_id";
    print(url);
    var header = {"Content-Type": "application/json", "lang": lang};
    try {
      final response = await http.get(Uri.parse(url), headers: header);
  ...
  Future<List<SemillarDetail>> getRecomendationProduct(
      String lang, var vendor_id) async {
    String url =
        baseURL + "api/home/get-preferred-products-by-userId?userId=$vendor_id";
    var header = {"Content-Type": "application/json", "lang": lang};
    try {
      final response = await http.get(Uri.parse(url), headers: header);
      print(response.body);
  ...
  Future<List<ProductGallaryDetail>> getProductGallary(var Product_id) async {
    String url =
        baseURL + "api/products/get-product-attachments?poductId=$Product_id";
    var header = {
    ...
    try {
      ...
      if (response.statusCode == 200 && response.body != null) {
        List slideritems = json.decode(utf8.decode(response.bodyBytes))["data"];
        return slideritems
            .map((e) => ProductGallaryDetail.fromJson(e))
            .toList();
      }
    } catch (e) {
      print('$e,,,,error search doctors');
  ...
  Future<Map<String, dynamic>> addFollowers(
      String lang, String token, String vendor_id, String UserId) async {
    ...
    var body = {"UserId": UserId, "VendorId": vendor_id};
    print(body);
    try {
      final response = await http.post(Uri.parse(url),
          body: json.encode(body), headers: header);
  ...
  Future<Map<String, dynamic>> deleteFollower(
      String lang, String token, String vendor_id, String UserId) async {
    var url =
        "${baseURL}api/follower/delete-follower?userId=$UserId&vendorId=$vendor_id";
    var header = {
      "Content-Type": "application/json",
      "lang": lang,
      "token": "Bearer " + token
  ...
  Future<Map<String, dynamic>> SetRate(String lang, String token,
      String Comment, int RateNum, String ProductId, String UserId) async {
...
class AddOrderDetail {
  ...
  AddOrderDetail(
      {this.ProductId, this.Quantity, this.ColorId, this.ProductSizeId});
