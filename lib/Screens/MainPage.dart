...
class _state extends State<MainPage> {
  ...
  loadData() async {
    ...
    BestList = await productServices.getBestSeller(
        Prefs.getString("lang"), Prefs.getString("token"));
    OffersList = await productServices.getOffers(
        Prefs.getString("lang"), Prefs.getString("token"));
    LastList = await productServices.getlastAdd(
        Prefs.getString("lang"), Prefs.getString("token"));
            ...
            children: [
                    ...
                    child: ListView(
                      ...
                      children: [
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                                context, GlobalFunction.route(Category()));
                          },
                          child: Container(
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                                context, GlobalFunction.route(SubCategory()));
                          },
                          child: Container(
                            width: MediaQuery.of(context).size.width * .15,
                            child: Column(
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                                context, GlobalFunction.route(Bran()));
                          },
                          child: Container(
                            width: MediaQuery.of(context).size.width * .15,
                            child: Column(
                      ...
                      GestureDetector(
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                                context, GlobalFunction.route(LangSetting()));
                          },
                          child: Container(
                            width: MediaQuery.of(context).size.width * .15,
                            child: Column(
              ...
              adv
                  ? Container(
                      ...
                      child: new Swiper(
                          ...
                          return Container(
                            ...
                            child: ClipRRect(
                              borderRadius:
                                  BorderRadius.all(Radius.circular(10)),
                              child: Image.network(
                                GlobalVariable.URl + advList[index].photo,
                                fit: BoxFit.fill,
                                height:
                        ...
                        control:
                            new SwiperControl(color: Colors.white, size: 0),
                      ),
                    )
                  : SizedBox(),
              GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      GlobalFunction.route(ProductsHome(BestList,
                          DemoLocalizations.of(context).title["bestSeller"])));
                },
                child: Container(
                        ...
                        itemBuilder: (context, index) {
                          return GestureDetector(
                            onTap: () {
                              Navigator.push(
                                  context,
                                  GlobalFunction.route(ProductDetails(
                                      BestList[index].id,
                                      BestList[index].name)));
                            },
                            child: Container(
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      GlobalFunction.route(ProductsHome(OffersList,
                                    ...
                                    child: Container(
                                      child: ClipRRect(
                                        borderRadius: BorderRadius.only(
                                            topLeft: Radius.circular(5),
                                            topRight: Radius.circular(5)),
                                        child: LastList[index].coverPhoto ==
                                                null
                                            ? SizedBox()
                                            : Image.network(
                                                GlobalVariable.URl +
                                                    LastList[index].coverPhoto,
                                                width: MediaQuery.of(context)
                                                    .size
                                                    .width,
                                                fit: BoxFit.fill,
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      GlobalFunction.route(ProductsHome(LastList,
                          DemoLocalizations.of(context).title["lastAdded"])));
                },
                child: Container(
                    width: MediaQuery.of(context).size.width * .94,
                    height: MediaQuery.of(context).size.height * .05,
                                        ...
                                        Container(
                                          child: Column(
                                            ...
                                            crossAxisAlignment:
                                                CrossAxisAlignment.start,
                                            children: [
                                              CustomText.CustomText10(LastList[
                                                          index]
                                                      .offerPrice
                                                      .toString() +
                                                  "  " +
