...
class LastWatched extends StatefulWidget{
  List <Product1Detail>data;
  String name;
  LastWatched(List <Product1Detail>data,String name){
    this.name=name;
    this.data=data;
  }
  @override
...
class _state extends State<LastWatched>{
  List <Product1Detail>data;
  String name;
  _state(List <Product1Detail>data,String name){
    this.name=name;
    this.data=data;
  }
  @override
