...
class BuyNow extends StatefulWidget{
   ...
   String price;
   int counter;
   BuyNow( String product,String image, String price,String id,String color_id,String size_id,int counter){
  ...
  State<StatefulWidget> createState() {
    return _state(this.product,this.image,this.price,this.id,this.color_id,this.size_id,this.counter);
  }
}
class _state extends State<BuyNow>{
  int index=1;
  String product;
  String image;
  String color_id;
  ...
  String id;
  int counter;
  _state( String product,String image, String price,String id,String color_id,String size_id,int counter){
    this.product=product;
    this.id=id;
    this.color_id=color_id;
    this.size_id=size_id;
                          ...
                          Container(
                            ...
                            child: ClipRRect(
                              ...
                              child:FadeInImage.assetNetwork(
                                ...
                                image:image==null?"":GlobalVariable.URL2+image,
                                width: MediaQuery.of(context).size.width*.9,
                                height: MediaQuery.of(context).size.height*.08,
                                fit: BoxFit.fill,
                              ),
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      Text(product,style: TextStyle(height: 1.0,fontSize: 14,color: Color(h.mainColor)),),
                                    ],),
                                ),
                                ...
                                Container(
                                  ...
                                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      Text(price+"",style: TextStyle(color: Colors.black,fontSize: 11),),
                      ...
                      Row(
                        children: [
                          Container(
                            ...
                            alignment: Alignment.center,
                            child: Text((price).toString(),style: TextStyle(fontSize: 12),),
                          ),
                ...
                GestureDetector(
                  child: Container(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(DemoLocalizations.of(context).title['total']+" "+(price).toString()+" "+"",style: TextStyle(color:Colors.white,fontSize: 12)),
                  ...
                  onTap: () async {
                    ...
                    if(prefs.getString("address_id")!=null){
                     ...
                     //  Map<String, dynamic> result = Map.fromIterable(Items, key: (v) => v.ProductId.toString(), value: (v) => v.Quantity.toString());
                      Map<String,dynamic>data=await productServices.addOrders(prefs.getString("lang"), prefs.getString("id"), double.parse(price), prefs.getString("address_id"), Items);
                      if(data["status"]==200){
                        print(data);
