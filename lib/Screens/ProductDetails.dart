...
class _state extends State<ProductDetails> {
  ...
  loadData() async {
    ...
    data = await productServices.getProductDetails(
        prefs.getString("lang"), this.id);
    Specification = await productServices.GesProductSpefication(
        prefs.getString("lang"), this.id);
    colorList =
        await productServices.getProductColor(prefs.getString("lang"), this.id);
    sizeList =
        await productServices.getProductSize(prefs.getString("lang"), this.id);
    SimillarProducts = await productServices.getSemillarProduct(
        prefs.getString("lang"), this.id);
    ratelist = await productServices.getProductRateWithImage(
        prefs.getString("lang"), this.id);
    sidesList =
        await productServices.getProductSides(prefs.getString("lang"), this.id);
    questions =
        await productServices.GetQuestion(prefs.getString("lang"), this.id);
    reviews =
        await productServices.getProductRate(prefs.getString("lang"), this.id);
    RecomendationProducts = await productServices.getRecomendationProduct(
        prefs.getString("lang"), data["vendorId"]);
    gallary = await productServices.getProductGallary(this.id);
    print(data["imagesPaths"]);
    setState(() {
    ...
    if (prefs.getString("id") != null) {
      Map<String, dynamic> responce =
          await productServices.addWatch(lang, this.id, prefs.getString("id"));
                                ...
                                : Container(
                                    ...
                                    child: ListView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          ...
                                          return gallary[index].type == "Video"
                                              ? Container(
                            ...
                            Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        data["numberOfSellerItems"].toString(),
                                        style: TextStyle(
                                            color: Color(h.mainColor),
                                            fontWeight: FontWeight.bold,
                                            fontSize: 18),
                               ...
                               SizedBox(width: 10,),*/
                                          GestureDetector(
                                            onTap: () async {
                                              FavoriteModelLocal favoriteModel =
                                                  FavoriteModelLocal({
                                                'id': data["id"].toString(),
                                                'title': data["name"],
                                                "description":
                                              ...
                                              int x = await triggerFavourite(
                                                  data["id"], favoriteModel);
                                              // print('${x},,,,,,favorite');
                                              if (mounted) setState(() {});
                                              if (x == 1) {
                                                Toast.show(
                                                    "Product Has Been Added To Favourite",
                                                    context,
                                                    duration:
                                                        Toast.LENGTH_SHORT,
                                                ...
                                                Toast.show(
                                                    "Product Has Been Removed From Favourite",
                                                    context,
                                                    duration:
                                                        Toast.LENGTH_SHORT,
                                                    gravity: Toast.BOTTOM);
                   ...
                   child: Text(DemoLocalizations.of(context).title["Reviews"],style: TextStyle(fontSize:16,fontWeight: FontWeight.bold,color: Colors.white),),
                            ...
                            GestureDetector(
                              onTap: () {
                                Navigator.push(
                                    context,
                                    GlobalFunction.route(ProductQuestion(
                                        data["id"], this.name)));
                              },
                              child: Container(
                                width: MediaQuery.of(context).size.width * .9,
                          ...
                          children: [
                            InkWell(
                              ...
                              child: Container(
                                ...
                                alignment: Alignment.center,
                                child: Text(
                                  DemoLocalizations.of(context).title["store"],
                              ...
                              onTap: () async {
                                if (sizeList.length == 0 &&
                                  ...
                                  try {
                                    ...
                                    setState(() {
                                      ParentPage.counter =
                                          ParentPage.counter + 1;
                                      ParentPage.total = ParentPage.total +
                                          double.parse(
                                              data["offerPrice"].toString());
                                      ParentPage.quantity =
                                          ParentPage.quantity + 1;
                                    });
                                    prefs.setString(
                                        "total", ParentPage.total.toString());
                                    prefs.setString("quantity",
                                        ParentPage.quantity.toString());
                                    /*   addProductDialog(context,"Product has Been Added To Shopping Cart", Container(
                              padding: EdgeInsets.only(top: 13),
                              child: Icon(Icons.check_circle,size: 50,color: Color(h.mainColor),),
                            ),);*/
                              ...
                              onTap: () async {
                                ...
                                if (ParentPage.user_id != null) {
                                  ...
                                  Navigator.push(context,
                                      GlobalFunction.route(Login("buy")));
                                }
                              },
                              child: Container(
                                width: MediaQuery.of(context).size.width * .4,
  ...
  Future<int> triggerFavourite(
      String productId, FavoriteModelLocal favoriteModel) async {
                                    ...
                                    Text(
                                      price +
                                          ...
                                          DemoLocalizations.of(context)
                                              .title["le"],
                                      style:
                                          TextStyle(color: Color(h.mainColor)),
                                    )
                                  ],
                                ),
                                SizedBox(
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    crossAxisAlignment:
                                        CrossAxisAlignment.start,
                                    children: [
                                      colorList.length == 0 || colorList == null
                                          ? SizedBox()
                                          : Column(
                                              children: [
                                                SizedBox(
                                      ...
                                      sizeList.length == 0 || sizeList == null
                                          ? SizedBox()
                                          : Column(
                                              children: [
                                                SizedBox(
                                    ...
                                    try {
                                      ...
                                      setState(() {
                                        ParentPage.counter =
                                            ParentPage.counter + 1;
                                        ParentPage.total = ParentPage.total +
                                            (double.parse(data["offerPrice"]
                                                    .toString()) *
                                                counter);
                                        ParentPage.quantity =
                                            ParentPage.quantity + counter;
                                      });
                                      prefs.setString(
                                          "total", ParentPage.total.toString());
                                      prefs.setString("quantity",
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  price +
                                      "  " +
                                      DemoLocalizations.of(context).title["le"],
