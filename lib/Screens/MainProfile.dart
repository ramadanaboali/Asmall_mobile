                          ...
                          child: Column(
                            children: [
                              ...
                              GestureDetector(
                                onTap: () {
                                  Navigator.push(context,
                                      GlobalFunction.route(ProfileSetting()));
                                },
                                child: Row(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        Navigator.push(context,
                                            GlobalFunction.route(Favourite()));
                                      },
                                      child: Column(
                                        children: [
                                          Icon(
                                    ...
                                    GestureDetector(
                                      onTap: () async {
                                        ...
                                        Navigator.push(
                                            context,
                                            GlobalFunction.route(LastWatched(
                                                data,
                                                DemoLocalizations.of(context)
                                                    .title["lastWatched"])));
                                      },
                              ...
                              GestureDetector(
                                onTap: () {
                                  Navigator.push(
                                      context, GlobalFunction.route(Orders()));
                                },
                                child: Container(
                                  width:
                                      MediaQuery.of(context).size.width * .94,
                                    ...
                                    children: [
                                      CustomText.TitleText(
                                          DemoLocalizations.of(context)
                                              .title["orders"]),
                                      CustomText.SubTitleText(
                                          "${DemoLocalizations.of(context).title["seeall"]} >>"),
                                    ],
                                  ),
                                ),
                              ),
